      ...
      <div className="max-w-screen-lg mx-auto flex flex-col px-4">
        ...
        <div className="mt-8">
          <Link href="/voting-session">
            <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-md shadow-md hover:shadow-lg transform hover:scale-105 duration-300">
        ...
        <div className="movie-scroll mt-4 overflow-x-scroll whitespace-nowrap scrollbar-hide">
          {popularMovies.slice(0, 20).map((movie: Movie) => (
            <Link href={`/movies/${movie.id}`} key={movie.id}>
              <button className="shadow-md hover:shadow-lg transform hover:scale-105 duration-300">
